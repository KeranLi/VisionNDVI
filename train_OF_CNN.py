...
class SimpleCNNModel(nn.Module):
    def __init__(self):
        ...
        self.conv4 = nn.Conv2d(128, 1, kernel_size=1)  # 1 output channel, but we flatten this out
    ...
    def forward(self, x):
        ...
        return x  # Final output directly matches (batch_size, H, W)
...
if torch.cuda.device_count() > 1:
    ...
    model = nn.DataParallel(model, device_ids=[0, 1, 2])  # Use nn.DataParallel with specified GPUs
else:
